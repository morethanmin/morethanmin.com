...
export const Colors: colorsType = {
  ...
  red: {
    ...
    bg: {
      ...
      gradient:
        'from-hex-ff3b30 to-hex-ff9500 dark:(from-hex-ff453a to-hex-ff9f0a)',
    },
  },
  orange: {
    text: {
    ...
    bg: {
      ...
      gradient:
        'from-hex-ff9500 to-hex-ffcc00 dark:(from-hex-ff9f0a to-hex-ffd60a)',
    },
  },
  yellow: {
    text: {
    ...
    bg: {
      ...
      gradient:
        'from-hex-ffcc00 to-hex-34c759 dark:(from-hex-ffd60a to-hex-30d158)',
    },
  },
  green: {
    text: {
    ...
    bg: {
      ...
      gradient:
        'from-hex-34c759 to-hex-007aff dark:(from-hex-30d158 to-hex-0a84ff)',
    },
  },
  blue: {
    text: {
    ...
    bg: {
      ...
      gradient:
        'from-hex-007aff to-hex-34c759 dark:(from-hex-0a84ff to-hex-30d158)',
    },
  },
  pink: {
    text: {
    ...
    bg: {
      ...
      gradient:
        'from-hex-ff2d55 to-hex-ff3b30 dark:(from-hex-ff375f to-hex-ff453a)',
    },
  },
  purple: {
    text: {
    ...
    bg: {
      ...
      gradient:
        'from-hex-5856d6 to-hex-007aff dark:(from-hex-5856d6 to-hex-0a84ff)',
    },
  },
  brown: {
    text: {
    ...
    bg: {
      ...
      gradient:
        'from-hex-a2845e to-hex-ffcc00 dark:(from-hex-ac8e68 to-hex-ffd60a)',
    },
  },
  gray: {
    text: {
